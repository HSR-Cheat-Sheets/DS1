...
\newcommand{\INSTITUTE}{University of applied sciences Rapperswil}
...
\titleformat{name=\paragraph}{\sffamily\small\bfseries}{}{0pt}{\colorparagraph}
\titlespacing*{\paragraph}{0pt}{0pt}{0pt}
\newcommand{\colorparagraph}[1]{%
    \color{sectionColor}\ #1 \vspace{-2pt}}
